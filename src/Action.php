            ...
            try{
                ...
                if ( isset($_REQUEST['usrid']) 
                    ...
                    if ( isset($_REQUEST['comment']) ){
                        ...
                        $db->direct("insert into wa_action_log (user ,login , action, comment) VALUES ('".$_SESSION['wa_session']['login']['vorname']." ".$_SESSION['wa_session']['login']['nachname']."','".$_SESSION['wa_session']['login']['user']."','".$action."','".$comment."')" ,[]);
                    }else{
