            ...
            try{
                ...
                if ( isset($_REQUEST['usrid']) 
                    ...
                    if ( isset($_REQUEST['usrid'])){
                        ...
                        $db->direct("insert into wa_action_log (user ,login , action, comment,ip_address) VALUES ('".$_SESSION['wa_session']['login']['vorname']." ".$_SESSION['wa_session']['login']['nachname']."','".$_SESSION['wa_session']['login']['user']."','Nicht erlaubt !!!',' SCHUMMEL - VERSUCH','".$_SERVER['REMOTE_ADDR']."')" ,[]);
                    }
                }
